{
  ...
  outputs = { self, julia2nix, nixpkgs, devshell, flake-utils, poetry2nix, ... }@inputs: 
    (
          ...
          commands = [
            {
              name = "pluto";
              command = ''
              ${julia-wrapped}/bin/julia ${startPlutoScript}
              '';
            }
            {
              ...
              name = "hello-world";
              command = ''
              ${hello-world}/bin/python3 ${project}/hello.py
              '';
            }
            {
              package = julia-wrapped;
